...
struct MenuView: View {
    ...
    var body: some View {
        ...
        RefreshableNavigationView(content: {
            ...
            // Hier kannst du zusätzlichen Code für die Aktualisierung hinzufügen
...
struct ColorCirclePicker: View {
    ...
    let predefinedColors: [[Color]] = [
        ...
        [Color(red: 0.0, green: 0.0, blue: 0.8), .yellow, Color(red: 0.8, green: 0.0, blue: 0.8), Color(red: 0.0, green: 0.8, blue: 0.4)]
    ]
